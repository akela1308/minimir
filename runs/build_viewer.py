  ...
  <div class="modal" role="dialog" aria-modal="true" aria-label="о проекте">
    ...
    <ul>
      ...
      <li><b>Ступень 3 — знак.</b> Может ли метка, которую существо оставляет
        <i>для других</i>, со временем стать инструментом <i>для себя самого</i>?</li>
    </ul>

    <h3>Откуда растёт идея: Выготский и Ильенков</h3>
    <p>Ступень 3 — это прямая проверка мысли психолога
      <a href="https://ru.wikipedia.org/wiki/Выготский,_Лев_Семёнович" target="_blank" rel="noopener">Льва Выготского</a>:
      <b>всякая способность появляется дважды — сначала между людьми, потом
      внутри человека</b>. Сначала слово или знак — это способ обратиться
      к другому («посмотри туда»), и лишь позже тот же знак человек начинает
      применять к себе и так перестраивает собственное мышление. Его пример —
      узелок на платке «чтобы не забыть»: внешняя подсказка, которую сам себе
      оставил. Наш вопрос ровно такой: <b>сменит ли метка адресата с «другого»
      на «себя» в течение жизни одного существа?</b></p>
    <p>Философ <a href="https://ru.wikipedia.org/wiki/Ильенков,_Эвальд_Васильевич" target="_blank" rel="noopener">Эвальд Ильенков</a>
      довёл эту мысль до предела: <b>смыслы и «идеальное» живут не в мозге, а во
      внешних вещах и совместных делах людей</b> — в знаках, орудиях, культуре;
      а мозг лишь «подключается» к этому. Отсюда его сильное утверждение —
      <b>потребности и саму психику можно собрать извне</b>. Он ссылался на
      Загорский интернат, где у слепоглухих детей внутренний мир и потребности
      выстраивали снаружи, через совместную деятельность со взрослыми.</p>
    <p>Почему это важно для нас: до сих пор всё «внутреннее» у наших существ
      было врождённым, зашитым в гены. Знак — <b>первое место, где нечто,
      управляющее поведением, могло бы прийти извне</b>, из взаимодействия, а не
      из генома. Если бы существо выучивало это при жизни в нужном порядке —
      у идеи «потребность можно дать извне» появилось бы не рассуждение,
      а измерение. Пока не выучивает — это тоже ответ: значит, одной уязвимости
      и меток для этого мало, нужно что-то ещё.</p>
