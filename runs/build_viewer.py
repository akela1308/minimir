...
<div class="wrap">
  <header>
    <div class="eyebrow">искусственная жизнь · записанный прогон</div>
    <h1>мини<span class="dot">·</span>мир</h1>
    <div class="thesis">Тор 128×128, один ресурс, необратимая смерть. Агентами
      управляют эволюционирующие сети; никакой функции приспособленности — только
      кто накопил энергию и поделился. Ниже — не игра, а воспроизведение реального
      прогона движка: цвет агента = его энергия, зелёное = еда, <span class="flag">жёлтое</span> = метки.</div>
...
document.getElementById('cond').textContent=M.cond;
